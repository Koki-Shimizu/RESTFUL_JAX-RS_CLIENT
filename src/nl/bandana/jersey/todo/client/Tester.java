package nl.bandana.jersey.todo.client;
...
import nl.bandana.jersey.todo.model.Todo;
...
public class Tester {
	...
	private static URI getBaseURI() {
		return UriBuilder.fromUri("http://localhost:8080/nl.bandana.jersey.todo").build();
	}
}